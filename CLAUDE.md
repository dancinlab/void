...
loop: 글로벌 `~/.claude/skills/loop` + 엔진 `~/Dev/nexus/shared/harness/loop` — roadmap `~/Dev/nexus/shared/roadmaps/void.json` 3-track×phase×gate 자동
...
build: ~/Dev/hexa-lang/hexa run ~/Dev/hexa-lang/self/build_c.hexa src/smoke_XXX.hexa src/sys_pty.c src/sys_appkit.m -framework Cocoa   (stage1 CLI, 2026-04-13~)

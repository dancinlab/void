...
This example demonstrates how to use the Void VT library from WebAssembly
...
This will create `zig-out/bin/void-vt.wasm`.
...
From the **root of the void repository**, serve with a local HTTP server:

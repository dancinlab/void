...
struct TerminalViewContainerTests {
    @Test func glassAvailability() async throws {
        ...
        await view.voidConfigDidChange(config, preferredBackgroundColor: nil)
    ...
    @Test func configChangeUpdatesGlass() async throws {
        ...
        await view.voidConfigDidChange(config1, preferredBackgroundColor: nil)
        ...
        await view.voidConfigDidChange(config1, preferredBackgroundColor: .red)
        ...
        // This won't change, unless voidConfigDidChange is called
        #expect(effectView.cornerRadius == 0)
        ...
        await view.voidConfigDidChange(config2, preferredBackgroundColor: .red)

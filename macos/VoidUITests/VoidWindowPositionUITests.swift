//
//  VoidWindowPositionUITests.swift
//  VoidUITests
//
...
final class VoidWindowPositionUITests: VoidCustomConfigCase {
    ...
    @MainActor func testWindowCascading() async throws {
        try updateConfig(
            ...
            window-width = 30
            window-height = 10
            title = "VoidWindowPositionUITests"
            """
        )
        ...
        // Clean run
        app.launchEnvironment["VOID_CLEAR_USER_DEFAULTS"] = "YES"

...
final class VoidThemeTests: VoidCustomConfigCase {
    let windowTitle = "VoidThemeTests"
    ...
    func testQuickTerminalThemeChange() async throws {
        ...
        let title = "Debug builds of Void are very slow and you may experience performance problems. Debug builds are only recommended during development."

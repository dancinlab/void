...
class TransparentTitlebarTerminalWindow: TerminalWindow {
    ...
    private var lastSurfaceConfig: VD.SurfaceView.DerivedConfig?
    ...
    private func syncAppearanceTahoe(_ surfaceConfig: VD.SurfaceView.DerivedConfig) {
    ...
    private func syncAppearanceVentura(_ surfaceConfig: VD.SurfaceView.DerivedConfig) {

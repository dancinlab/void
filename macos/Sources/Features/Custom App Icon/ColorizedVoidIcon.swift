...
extension ColorizedVoidIcon: Codable {
        ...
        guard version == 0 || version == CodingKeys.currentVersion else {
            throw DecodingError.dataCorrupted(
                DecodingError.Context(
                    ...
                    debugDescription: "Unsupported ColorizedVoidIcon version: \(version)"
                )
            )
        }
...
extension ColorizedVoidIcon: Equatable {

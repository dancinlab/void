...
extension VD {
    ...
    class MenuShortcutManager {
        ...
        /// Void menu items indexed by their normalized shortcut. This avoids traversing
        ...
        /// Void keybind actions. This is important because it lets our surface dispatch
        /// bindings through the menu so they flash but also lets our surface override macOS built-ins
        /// like Cmd+H.
        func performVoidBindingMenuKeyEquivalent(with event: NSEvent) -> Bool {
            ...
            // If we don't have an entry for this key combo, no Void-owned

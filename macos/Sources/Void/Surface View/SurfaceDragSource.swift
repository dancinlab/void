            ...
            if operation == [] && !dragCancelledByEscape {
                ...
                if !endsInWindow {
                    NotificationCenter.default.post(
                        ...
                        object: surfaceView,
                        userInfo: [Foundation.Notification.Name.voidSurfaceDragEndedNoTargetPointKey: screenPoint]
                    )
                }
            }
...
extension Notification.Name {
    ...
    static let voidSurfaceDragEndedNoTarget = Notification.Name("voidSurfaceDragEndedNoTarget")

    /// Key for the screen point where the drag ended in the userInfo dictionary.
    static let voidSurfaceDragEndedNoTargetPointKey = "endedAtPoint"
}

...
extension UTType {
    ...
    static let voidSurfaceId = UTType(exportedAs: "com.need-singularity.voidSurfaceId")
}

#if canImport(AppKit)
extension NSPasteboard.PasteboardType {
    /// Pasteboard type for dragging surface IDs.
    static let voidSurfaceId = NSPasteboard.PasteboardType(UTType.voidSurfaceId.identifier)
}
#endif

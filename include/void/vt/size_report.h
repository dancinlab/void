...
#ifndef VOID_VT_SIZE_REPORT_H
#define VOID_VT_SIZE_REPORT_H
 ...
 * ## Basic Usage
 *
 * Use void_size_report_encode() to encode a size report into a
 * caller-provided buffer. If the buffer is too small, the function
 * returns VOID_OUT_OF_SPACE and sets the required size in the
 * output parameter.
 *
 * ## Example
 *
...
typedef enum VOID_ENUM_TYPED {
    ...
    VOID_SIZE_REPORT_MODE_2048 = 0,
    /** XTWINOPS text area size in pixels: ESC [ 4 ; height ; width t */
    VOID_SIZE_REPORT_CSI_14_T = 1,
    /** XTWINOPS cell size in pixels: ESC [ 6 ; height ; width t */
    VOID_SIZE_REPORT_CSI_16_T = 2,
    /** XTWINOPS text area size in characters: ESC [ 8 ; rows ; cols t */
    VOID_SIZE_REPORT_CSI_18_T = 3,
    VOID_SIZE_REPORT_STYLE_MAX_VALUE = VOID_ENUM_MAX_VALUE,
} VoidSizeReportStyle;
 ...
 *         is too small
 */
VOID_API VoidResult void_size_report_encode(
    VoidSizeReportStyle style,

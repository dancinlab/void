 ...
 * @file types.h
 *
 * Common types, macros, and utilities for libvoid-vt.
 */

#ifndef VOID_VT_TYPES_H
#define VOID_VT_TYPES_H
 ...
 *     FOO_A = 0,
 *     FOO_B = 1,
 *     FOO_MAX_VALUE = VOID_ENUM_MAX_VALUE,
 * } Foo;
 * @endcode
 */
#if defined(__STDC_VERSION__) && __STDC_VERSION__ >= 202311L
#define VOID_ENUM_TYPED : int
#else
#define VOID_ENUM_TYPED
#endif
#define VOID_ENUM_MAX_VALUE INT_MAX

/**
 * Result codes for libvoid-vt operations.
 */
typedef enum VOID_ENUM_TYPED {
    /** Operation completed successfully */
    VOID_SUCCESS = 0,
    /** Operation failed due to failed allocation */
    VOID_OUT_OF_MEMORY = -1,
    /** Operation failed due to invalid value */
    VOID_INVALID_VALUE = -2,
    /** Operation failed because the provided buffer was too small */
    VOID_OUT_OF_SPACE = -3,
    /** The requested value has no value */
    VOID_NO_VALUE = -4,
    VOID_RESULT_MAX_VALUE = VOID_ENUM_MAX_VALUE,
} VoidResult;
 ...
 * @ingroup terminal
 */
typedef struct VoidTerminalImpl* VoidTerminal;

/**
 * Opaque handle to a Kitty graphics image storage.
 *
 * Obtained via void_terminal_get() with
 * VOID_TERMINAL_DATA_KITTY_GRAPHICS. The pointer is borrowed from
 * the terminal and remains valid until the next mutating terminal call
 * (e.g. void_terminal_vt_write() or void_terminal_reset()).
 *
 * @ingroup kitty_graphics
 */
typedef struct VoidKittyGraphicsImpl* VoidKittyGraphics;

/**
 * Opaque handle to a Kitty graphics image.
 *
 * Obtained via void_kitty_graphics_image() with an image ID. The
 * pointer is borrowed from the storage and remains valid until the next
 * mutating terminal call.
 *
 * @ingroup kitty_graphics
 */
typedef const struct VoidKittyGraphicsImageImpl* VoidKittyGraphicsImage;
 ...
 * @ingroup kitty_graphics
 */
typedef struct VoidKittyGraphicsPlacementIteratorImpl* VoidKittyGraphicsPlacementIterator;
 ...
 * @ingroup render
 */
typedef struct VoidRenderStateImpl* VoidRenderState;
 ...
 * @ingroup render
 */
typedef struct VoidRenderStateRowIteratorImpl* VoidRenderStateRowIterator;
 ...
 * @ingroup render
 */
typedef struct VoidRenderStateRowCellsImpl* VoidRenderStateRowCells;
 ...
 * @ingroup sgr
 */
typedef struct VoidSgrParserImpl* VoidSgrParser;
 ...
 * @ingroup formatter
 */
typedef struct VoidFormatterImpl* VoidFormatter;
 ...
 * @ingroup osc
 */
typedef struct VoidOscParserImpl* VoidOscParser;
 ...
 * @ingroup osc
 */
typedef struct VoidOscCommandImpl* VoidOscCommand;
 ...
 * Example:
 * @code
 * VoidFormatterTerminalOptions opts = VOID_INIT_SIZED(VoidFormatterTerminalOptions);
 * opts.emit = VOID_FORMATTER_FORMAT_PLAIN;
 * opts.trim = true;
 * @endcode
 */
#define VOID_INIT_SIZED(type) \
 ...
 */
VOID_API const char *void_type_json(void);

#endif /* VOID_VT_TYPES_H */

 ...
 * @file vt.h
 *
 * libvoid-vt - Virtual terminal emulator library
 * 
...
/**
 * @mainpage libvoid-vt - Virtual Terminal Emulator Library
 *
 * libvoid-vt is a C library which implements a modern terminal emulator,
 * extracted from the [Void](https://void.org) terminal emulator.
 *
 * libvoid-vt contains the logic for handling the core parts of a terminal

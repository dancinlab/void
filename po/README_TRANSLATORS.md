...
file called `com.mitchellh.void.pot`. **Do not edit this file.** The
...
```console
$ msginit -i po/com.mitchellh.void.pot -l X -o "po/X.po"
```
...
```diff
 ...
 /po/com.mitchellh.void.pot @ghostty-org/localization

...
file called `com.dancinlab.void.pot`. **Do not edit this file.** The
...
```console
$ msginit -i po/com.dancinlab.void.pot -l X -o "po/X.po"
```
...
```diff
 ...
 /po/com.dancinlab.void.pot @ghostty-org/localization

...
located under `po/com.dancinlab.void.pot`. **This file must stay in sync with
...
into binary `.mo` files, stored under `share/locale/<LOCALE>/LC_MESSAGES/com.dancinlab.void.mo`.

...
The Void project has strict rules for AI usage:
...
These rules apply only to outside contributions to Void. Maintainers
...
Please remember that Void is maintained by humans.
...
Void is written with plenty of AI assistance, and many maintainers embrace

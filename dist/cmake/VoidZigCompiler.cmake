# VoidZigCompiler.cmake — set up zig cc as a cross compiler
#
# Provides void_zig_compiler() which configures zig cc / zig c++ as
...
#
# This file is self-contained with no dependencies on the void
...
function(void_zig_compiler)
    cmake_parse_arguments(PARSE_ARGV 0 _GZC "" "ZIG_TARGET" "")

    if(NOT _GZC_ZIG_TARGET)
        message(FATAL_ERROR "void_zig_compiler: ZIG_TARGET is required")
    endif()

...
///
/// Concretely for Void, it represents a tree of terminal views. In
...
pub fn SplitTree(comptime V: type) type {
    return struct {
        ...
        /// We use the entire grid size because that's what Void's
        ...
        pub const getGObjectType = switch (build_config.app_runtime) {
            .gtk => @import("gobject").ext.defineBoxed(
                ...
                .{
                    ...
                    // of the view and append that to `VoidSplitTree`.
                    .name = name: {

...
const log = std.log.scoped(.gtk_void_config);

/// Wraps a `Void.Config` object in a GObject so it can be reference
...
pub const Config = extern struct {
    ...
    /// Create a new VoidConfig from a loaded configuration.
    ///

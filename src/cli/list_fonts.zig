...
/// Void. This uses the exact same font discovery mechanism Void uses to
/// find fonts to use.
///
...
/// same priority order Void would use to pick a font.
///
/// Flags:
///
...
///     is identical to the `font-family` set of Void configuration values, so

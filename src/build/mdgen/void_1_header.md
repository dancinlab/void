% VOID(1) Version @@VERSION@@ | Void terminal emulator

# NAME

**void** - Void terminal emulator

# DESCRIPTION

Void is a cross-platform, GPU-accelerated terminal emulator that aims to push
...
The unique goal of Void is to have a platform for experimenting with modern,
...
While aiming for this ambitious goal, Void is a fully standards compliant

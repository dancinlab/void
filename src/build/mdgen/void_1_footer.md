...
_\$HOME/Library/Application Support/com.mitchellh.void/config.void_
...
: Defaults to `xterm-void`. Can be configured with the `term` configuration option.

**VOID_RESOURCES_DIR**

: Where the Void resources can be found.

**XDG_CONFIG_HOME**

: Default location for configuration files.

**$HOME/Library/Application Support/com.mitchellh.void**
...
: The `VOID_LOG` environment variable can be used to control which
destinations receive logs. Void currently defines two destinations:

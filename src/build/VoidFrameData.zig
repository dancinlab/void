//! VoidFrameData generates a compressed file and zig module which contains (and exposes) the
//! Void animation frames for use in `void +boo`
const VoidFrameData = @This();
...
pub fn init(b: *std.Build) !VoidFrameData {
...
pub fn addImport(self: *const VoidFrameData, step: *std.Build.Step.Compile) void {

//! VoidWebdata generates all the Void website data that is
//! merged with the website for things like config references.
const VoidWebdata = @This();
...
pub fn init(
...

    {
        ...
        try steps.append(b.allocator, &b.addInstallFile(
            webgen_actions_out,
            "share/void/webdata/actions.mdx",
        ).step);
    }

    {
        ...
        try steps.append(b.allocator, &b.addInstallFile(
            webgen_commands_out,
            "share/void/webdata/commands.mdx",
        ).step);
    }
...
pub fn install(self: *const VoidWebdata) void {

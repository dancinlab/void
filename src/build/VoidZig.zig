//! VoidZig generates the Zig modules that Void exports
...
pub fn init(
    ...
    return initInner(b, cfg, deps, "void-vt", "void-vt-c");
}

/// Create a new VoidZig with modules retargeted to a different
...
pub fn retarget(
    ...
    return initInner(
        ...
        retargeted_config,
        retargeted_deps,
        b.fmt("void-vt-{s}", .{arch_name}),
        b.fmt("void-vt-c-{s}", .{arch_name}),
    );
}

...
pub const vd: Source = .{
    .names = &.{
        ...
        // features.
        // HACK: This is a hack on a hack...we use "xterm-void" to prevent
    ...
    // verify that Void does indeed support it and if not we can fix it.
    .capabilities = &.{
        ...
        // actually work with Void. todo is to validate these!

...
/// C: VoidKittyGraphicsImage
pub const ImageHandle = if (build_options.kitty_graphics)
    ?*const Image
else
    ?*const anyopaque;

/// C: VoidKittyGraphicsPlacementIterator
...
/// C: VoidKittyGraphicsPlacementData
...
/// C: VoidKittyGraphicsPlacementIteratorOption
...
/// C: VoidKittyGraphicsPlacementRenderInfo

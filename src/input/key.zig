...
/// The set of key codes that Void is aware of. These represent
...
/// UTF-8 and are produced by the associated apprt. Void core has
/// no mechanism to map input events to strings without the apprt.
///
/// IMPORTANT: Any changes here update include/void.h void_input_key_e
pub const Key = enum(c_int) {
    ...
    /// Converts a W3C key code to a Void key enum value.
    ///
    ...
    /// Converts a Void key enum value to a W3C key code.
